...
echo "Crear una condición, que si no están esas letras, que muestre un mensaje"
if [ -d "Musica/Metal/Heavy/TiposHeavy.txt" ]; then
	grep -i "x" Musica/Metal/Heavy/TiposHeavy.txt"
else
	if [ -f "$Musica" ]; then
		grep -i "x" Musica/Metal/Heavy/TiposHeavy.txt
